...
function nrmi(alg::String, conjugate::Bool, outputFilename::String, numBurnin::Int64, numSample::Int64, numThinning::Int64, numEmptyClusters::Int64)
  ...
  # Sampling
  collectors = ["nbClusters", "nrmi_alpha", "nrmi_sigma", "nrmi_tau", "nrmi_logU", "prior_precisionInvScale"]
  sampler = Sampler(model, collectors, numBurnin, numSample, numThinning, outputFilename)
  runSampler(sampler)

end

function nrmi2(alg::String, conjugate::Bool, outputFilename::String, numBurnin::Int64, numSample::Int64, numThinning::Int64, numEmptyClusters::Int64, alpha::Float64, sigma::Float64)
